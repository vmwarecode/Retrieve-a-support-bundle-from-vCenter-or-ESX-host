...
public class GetSupportBundleUrlFromVcOrEsx {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 4 || args.length < 3) {
            System.out.println("Wrong number of arguments, must provide the following arguments:");
            ...
            System.out.println("[4] (optional) The esx host IP address (If provided, it will retrieve the ESX bundle instead of VC bundle)");
            System.exit(1);
        }
